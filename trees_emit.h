...
#define send_bits(s, t_val, t_len, bi_buf, bi_valid) {\
    ...
    sent_bits_add(s, len);\
    /* Branchless: always compute the merged value */\
    bi_buf |= val << bi_valid;\
...
/* ===========================================================================
 * Emit literal code (bi_buf/bi_valid passed by reference)
 */
...
/* ===========================================================================
 * Emit match distance/length code (bi_buf/bi_valid passed by reference)
 * Returns the number of bits emitted.
 */
static inline uint32_t zng_emit_dist(deflate_state *s, const ct_data *ltree, const ct_data *dtree,
    ...
    /* Single lookup for base_length and extra_lbits */
    ...
    /* Single lookup for base_dist and extra_dbits */
...
/* ===========================================================================
 * Emit end block (bi_buf/bi_valid passed by reference)
 */
