...
extern uint8_t* chunkcopy_c(uint8_t *out, uint8_t const *from, unsigned len, unsigned left);
...
extern uint8_t* chunkcopy_sse2(uint8_t *out, uint8_t const *from, unsigned len, unsigned left);
...
extern uint8_t* chunkcopy_avx(uint8_t *out, uint8_t const *from, unsigned len, unsigned left);
...
extern uint8_t* chunkcopy_neon(uint8_t *out, uint8_t const *from, unsigned len, unsigned left);
...
Z_INTERNAL uint8_t* chunkcopy_stub(uint8_t *out, uint8_t const *from, unsigned len, unsigned left) {
    // Initialize default
...
# endif
    ...
    return functable.chunkcopy(out, from, len, left);
}
