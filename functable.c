...
extern void     crc32_fold_copy_c(crc32_fold *crc, unsigned char *dst, const unsigned char *src, unsigned long len);
extern uint32_t crc32_fold_final_c(crc32_fold *crc);

#ifdef X86_PCLMULQDQ_CRC
extern uint32_t crc32_fold_reset_pclmulqdq(crc32_fold *crc);
extern void     crc32_fold_copy_pclmulqdq(crc32_fold *crc, unsigned char *dst, const unsigned char *src, unsigned long len);
...
Z_INTERNAL void crc32_fold_copy_stub(crc32_fold *crc, unsigned char *dst, const unsigned char *src, unsigned long len) {
