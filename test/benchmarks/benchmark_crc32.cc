...
#define BENCHMARK_CRC32(name, fptr, support_flag)               \
    ...
    BENCHMARK_REGISTER_F(crc32, name)                           \
        ->Arg(1)                                                \
        ->Arg(8)                                                \
        ->Arg(12)                                               \
        ->Arg(16)                                               \
...
/* CRC32 fold does a memory copy while hashing */
BENCHMARK_CRC32(vpclmulqdq, crc32_vpclmulqdq,
                (test_cpu_features.x86.has_pclmulqdq && test_cpu_features.x86.has_avx512_common &&
                 test_cpu_features.x86.has_vpclmulqdq));
#  endif
