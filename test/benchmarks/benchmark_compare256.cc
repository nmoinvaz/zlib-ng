...
BENCHMARK_COMPARE256(neon_v2, compare256_v2_neon, test_cpu_features.arm.has_neon);
BENCHMARK_COMPARE256(neon_v3, compare256_v3_neon, test_cpu_features.arm.has_neon);
#endif
#if defined(ARM_SVE)
