...
#  endif
#  ifdef LOONGARCH_CRC
    TEST_CRC32_COPY(loongarch, crc32_copy_loongarch, test_cpu_features.loongarch.has_crc)
#  endif
#  ifdef RISCV_CRC32_ZBC
    TEST_CRC32_COPY(riscv, crc32_copy_riscv_zbc, test_cpu_features.riscv.has_zbc)
#  endif
