...
cd btmp2
  cmake -G Xcode ${CMAKE_ARGS} .. -DCMAKE_OSX_SYSROOT=$sysroot -DCMAKE_SKIP_RPATH=ON -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_LINKER=libtool -DCMAKE_C_LINKER_EXECUTABLE="libtool -D -o <TARGET> <LINK_FLAGS> <OBJECTS>"
