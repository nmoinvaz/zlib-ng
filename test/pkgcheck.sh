...
cd btmp2
  cmake -G Ninja ${CMAKE_ARGS} .. -DCMAKE_OSX_SYSROOT=$sysroot -DCMAKE_SKIP_RPATH=ON -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_C_CREATE_SHARED_LIBRARY="ld -D -o <TARGET> <LINK_FLAGS> <OBJECTS>"
  ninja -v
  ninja install
cd ..
