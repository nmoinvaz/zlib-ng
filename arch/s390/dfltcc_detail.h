...
static inline dfltcc_cc dfltcc(int fn, void *param, unsigned char **op1, size_t *len1, z_const unsigned char **op2,
                               size_t *len2, void *hist) {
...
#endif
            "ipm %[cc]\n"
        : [r2] "+r"(r2), [r3] "+r"(r3), [r4] "+r"(r4), [r5] "+r"(r5), [cc] "=r"(cc)
        : [r0] "r"(r0), [r1] "r"(r1), [hist] "r"(hist)
#ifdef HAVE_SYS_SDT_H
                                          ,
...
static inline void append_history(struct dfltcc_param_v0 *param, unsigned char *history, const unsigned char *buf,
                                  uInt count) {
    size_t offset;
    size_t n;
...
static inline void get_history(struct dfltcc_param_v0 *param, const unsigned char *history, unsigned char *buf) {
    size_t hl_high, hl_low;
