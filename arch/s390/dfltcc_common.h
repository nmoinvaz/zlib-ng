...
#define DEFLATE_BOUND_COMPLEN(source_len)                                                                           \
    ((DFLTCC_BLOCK_HEADER_BITS + DFLTCC_HLITS_COUNT_BITS + DFLTCC_HDISTS_COUNT_BITS + DFLTCC_HCLENS_COUNT_BITS +    \
      DFLTCC_MAX_HCLENS * DFLTCC_HCLEN_BITS + (DFLTCC_MAX_HLITS + DFLTCC_MAX_HDISTS) * DFLTCC_MAX_HLIT_HDIST_BITS + \
      (source_len) * DFLTCC_MAX_SYMBOL_BITS + DFLTCC_MAX_EOBS_BITS + DFLTCC_MAX_PADDING_BITS) >>                    \
     3)
