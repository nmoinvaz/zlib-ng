...
#  endif
    ...
    return sysctlbyname("hw.optional.armv8_crc32", &hascrc32, &size, NULL, 0) == 0 && hascrc32 == 1;
#elif defined(_WIN32)
...
#  elif defined(__APPLE__)
    ...
    return sysctlbyname("hw.optional.neon", &hasneon, &size, NULL, 0) == 0 && hasneon == 1;
...
#  if defined(__linux__) && defined(HAVE_SYS_AUXV_H)
    ...
    return strncmp(platform, "v6l", 3) == 0 || strncmp(platform, "v7l", 3) == 0 || strncmp(platform, "v8l", 3) == 0;
